...
from grizzly_multi_impl import grizzly_numpy_impl
...
class DataFrameWeld:
    ...
    def __init__(self, df, predicates=None, impl=grizzly_numpy_impl):
        self.df = df
    ...
    def __getitem__(self, key):
        ...
        if isinstance(key, str):  # Single-key get
            ...
            if dtype == 'object':
                ...
                weld_type = self.impl.type_mapping[dtype]
    ...
    def __getattr__(self, key):
        ...
        if key == 'values':
            ...
            if isinstance(self.df.values, np.ndarray):
                weld_type = self.impl.numpy_to_weld_type_mapping[
...
class GroupByWeld:
    ...
    def __init__(self, df, grouping_column_name,
        ...
        if isinstance(column, LazyOpResult):
            ...
            self.grouping_column_type = self.impl.type_mapping[
                str(column.dtype)]
        ...
        for column_name in self.column_names:
            ...
            if isinstance(column, LazyOpResult):
                ...
                column_type = self.impl.type_mapping[
                    str(column.dtype)]
